...
//get user details from frontend
//validate userdata 
//check if user exists in db or not if not redirect to register
//validate user given password and password in db
//generate access and refresh token and save in dd
...
const updateUserAvatar = asyncHandler(async(req,res)=>{
    ...
    status(200).
    json(
        new ApiResponse(200,user,"avatar updated successfullty"))
})
...
const getUserChannelProfile = asyncHandler(async(req,res)=>{
    ...
    const channel = await User.aggregate([
        ...
        {
            //gathered subscribers and subscribed to channels
            $lookup:{
                from:"subscriptions",
                localField:"_id",
            ...
            //added two more fields in user info 
            $addFields:{
                subscribersCount:{
                    $size:"$subscribers"
                },
                ...
                //user subscribed to a channel or not 
                isSubscribed:{
                    $cond:{
